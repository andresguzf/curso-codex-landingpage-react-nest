...
export function CourseVisual({ course }: { course: Course }) {
  switch (course.visual) {
    ...
    case 'kafka':
      return <CourseVisualBase id={course.slug} accentA="#c08cff" accentB="#68329e" titleWidth={72} bodyWidths={[84, 60]} shape="kafka" />;
    case 'python':
      return <CourseVisualBase id={course.slug} accentA="#84c8ff" accentB="#3766a8" titleWidth={78} bodyWidths={[90, 64]} shape="python" />;
    case 'react':
      return <CourseVisualBase id={course.slug} accentA="#85e7ff" accentB="#2b6d8f" titleWidth={76} bodyWidths={[88, 68]} shape="react" />;
    case 'angular':
      return <CourseVisualBase id={course.slug} accentA="#ff7f8d" accentB="#92344f" titleWidth={70} bodyWidths={[84, 72]} shape="angular" />;
    case 'microservices':
      return <CourseVisualBase id={course.slug} accentA="#7bd1ff" accentB="#5478dd" titleWidth={44} bodyWidths={[54, 34]} shape="microservices" rightX={214} />;
    case 'docker':
      return <CourseVisualBase id={course.slug} accentA="#79d3ff" accentB="#2d7bcf" titleWidth={58} bodyWidths={[72, 46]} shape="docker" rightX={200} />;
    case 'kubernetes':
      return <CourseVisualBase id={course.slug} accentA="#9ac4ff" accentB="#4479d9" titleWidth={66} bodyWidths={[84, 58]} shape="kubernetes" rightX={192} />;
    case 'postgres':
      return <CourseVisualBase id={course.slug} accentA="#8ab0ff" accentB="#2f5ea8" titleWidth={70} bodyWidths={[82, 52]} shape="postgres" rightX={194} />;
    case 'java':
      return <CourseVisualBase id={course.slug} accentA="#f2b07c" accentB="#b85e37" titleWidth={92} bodyWidths={[76, 104]} shape="java" rightX={154} />;
    case 'testing':
      return <CourseVisualBase id={course.slug} accentA="#9fe27a" accentB="#4f9c4b" titleWidth={34} bodyWidths={[44, 28]} shape="testing" rightX={226} />;
    case 'aws':
      return <CourseVisualBase id={course.slug} accentA="#ffcb7d" accentB="#ef8b2d" titleWidth={64} bodyWidths={[76, 52]} shape="aws" rightX={196} />;
    case 'node':
      return <CourseVisualBase id={course.slug} accentA="#98dd7e" accentB="#4e9846" titleWidth={68} bodyWidths={[80, 60]} shape="node" rightX={192} />;
    default:
      return <CourseVisualBase id={course.slug} accentA="#85e7ff" accentB="#2b6d8f" titleWidth={76} bodyWidths={[88, 68]} shape="react" />;
  }
}
